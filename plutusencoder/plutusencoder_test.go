...
func assertSemanticRoundtrip[T any](t *testing.T, hexStr string, target T, network byte) {
	...
	if err := UnmarshalPlutus(&pd, dest, network); err != nil {
		t.Logf("pd.PlutusDataType=%v pd.TagNr=%v pd.ValueType=%T", pd.PlutusDataType, pd.TagNr, pd.Value)
	...
	roundPd := anyToPlutusData(roundAny)
	if pd.PlutusDataType != roundPd.PlutusDataType || fmt.Sprintf("%v", pd.Value) == fmt.Sprintf("%v", roundPd.Value) && pd.TagNr != roundPd.TagNr {
		// fallback: compare encoded bytes (canonical) when possible
		if hex.EncodeToString(encoded) != hexStr {
			t.Fatalf("semantic roundtrip mismatch: original %s vs roundtrip %s", hexStr, hex.EncodeToString(encoded))
		}
	}
}
...
func TestNestedListMarshal(t *testing.T) {
	...
	assertSemanticRoundtrip(t, "d87a9f44010203041a000f42409fd87b8344010203041a000f42404401020304d87b8344010203041a000f42404401020304ffff", d, 1)
}
...
func TestPlutusMarshal(t *testing.T) {
	...
	assertSemanticRoundtrip(t, "d87a8444010203044b48656c6c6f20576f726c641a000f4240d87b8344010203041a000f42404401020304", d, 1)
}
...
func TestPDAddressesStruct(t *testing.T) {
	...
	assertSemanticRoundtrip(t, "d87b81d8799fd8799f581cbb2ff620c0dd8b0adc19e6ffadea1a150c85d1b22d05e2db10c55c61ffd8799fd8799fd8799f581c3b8c8a100c16cf62b9c2bacc40453aaa67ced633993f2b4eec5b88e4ffffffff", d, 1)
}
...
func TestPDAddress(t *testing.T) {
	...
	assertSemanticRoundtrip(t, "d8799fd8799f581cbb2ff620c0dd8b0adc19e6ffadea1a150c85d1b22d05e2db10c55c61ffd8799fd8799fd8799f581c3b8c8a100c16cf62b9c2bacc40453aaa67ced633993f2b4eec5b88e4ffffffff", decoded_addr, 1)
	...
	assertSemanticRoundtrip(t, "d8799fd87a9f581c4ab17afc9a19a4f06b6fe229f9501e727d3968bff03acb1a8f86acf5ffd8799fd8799fd8799f581cb60abac5d101517cd99ae6c6c9ab582bc8603a07b57941df212782c5ffffffff", decoded_addr, 1)
	...
	encoded, _ = cbor.Encode(pd)
	assertSemanticRoundtrip(t, "d8799fd87a9f581c6ec4acc3fbbd570ada625f24902777cec5d7a349fa0f3c7ba87b0cffffd87a9fffff", decoded_addr, 1)
...
func (m IntMapOfAssetCustom) FromPlutusData(
	...
	if pd.PlutusDataType != PlutusData.PlutusMap && pd.PlutusDataType != PlutusData.PlutusIntMap {
