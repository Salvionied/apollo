...
type Transaction struct {
	TransactionBody       TransactionBody.TransactionBody             `cbor:"0,keyasint"`
	TransactionWitnessSet TransactionWitnessSet.TransactionWitnessSet `cbor:"1,keyasint"`
	Valid                 bool                                        `cbor:"2,keyasint"`
	AuxiliaryData         *Metadata.AuxiliaryData                     `cbor:"3,keyasint,omitempty"`
}
