...
func TestRandom(t *testing.T) {
	...
	//		{"map":
	//			[
	//				{"k":{"int":0},"v":{"map":[{"k":{"bytes":""},"v":{"map":[{"k":{"bytes":""},"v":{"int":10000000}}]}}]}
	//		},
	//		{"k":{"int":1},"v":{"map":[]}}]},
	//		{"list":
	...
	//				{"bytes":""},{"bytes":""}]},
	//		{"constructor":0,"fields":[
	//			{"bytes":"a0028f350aaabe0545fdcb56b039bfb08e4bb4d8c4d7c3c7d481c235"},{"bytes":"484f534b59"}]}]},
	//		{"constructor":0,"fields":[
	//			{"bytes":"279afa4c71ea050339f0699de9095daa612485ee8489fc413e93ebda"},
	//			{"bytes":"53505f725650717978"}]},
	//		{"map":[{"k":{"bytes":"656e6444617465"},"v":{"constructor":7,"fields":[{"int":4105123199000}]}},{"k":{"bytes":"7072696365"},"v":{"constructor":2,"fields":[{"constructor":0,"fields":[{"int":3259},{"int":50000}]}]}},{"k":{"bytes":"737461727444617465"},"v":{"constructor":7,"fields":[{"int":1704712851893}]}}]},{"map":[]}]}
	decoded_json, _ := hex.DecodeString("")
	pd := PlutusData.PlutusData{}
	err := pd.UnmarshalJSON(decoded_json)
	if err != nil {
		log.Fatal(err)
	}
	fmt.Println("json", string(decoded_json))
	fmt.Println("PD", pd)
	marshaled, _ := cbor.Marshal(pd)
	if hex.EncodeToString(marshaled) != "" {
		t.Error("Wrong json deserialization", "got", hex.EncodeToString(marshaled))
	}
	// pd = PlutusData.PlutusData{}
	// decodedCbor, _ := hex.DecodeString("")
	// err = pd.UnmarshalCBOR(decodedCbor)
	// if err != nil {
	// 	log.Fatal(err)
	// }
	// fmt.Println("SECOND DATUM", pd.String())
}
