...
func anyToPlutusDataLocal(v any) PlutusData {
	...
	case cbor.Tag:
		...
		case 121:
			// PlutusBool false
			return PlutusData{PlutusDataType: PlutusInt, Value: int64(0), TagNr: 121}
		case 122:
			// PlutusBool true or PlutusList indef
			if val.Content == nil {
				return PlutusData{PlutusDataType: PlutusInt, Value: int64(1), TagNr: 122}
			} else {
				contentPd := anyToPlutusDataLocal(val.Content)
				return PlutusData{PlutusDataType: PlutusArray, Value: contentPd.Value, TagNr: 122}
			}
		case 123:
			// PlutusList def
			contentPd := anyToPlutusDataLocal(val.Content)
	...
	case uint64:
		return PlutusData{PlutusDataType: PlutusInt, Value: int64(val)}
	case big.Int:
		return PlutusData{PlutusDataType: PlutusBigInt, Value: val}
	case []byte:
		return PlutusData{PlutusDataType: PlutusBytes, Value: val}
	case string:
		return PlutusData{PlutusDataType: PlutusBytes, Value: []byte(val)}
	case interface{ Bytes() []byte }:
		return PlutusData{PlutusDataType: PlutusBytes, Value: val.Bytes()}
	case nil:
		return PlutusData{PlutusDataType: PlutusArray, Value: PlutusIndefArray{}}
	default:
		if v == nil {
			return PlutusData{PlutusDataType: PlutusArray, Value: PlutusIndefArray{}}
		}
