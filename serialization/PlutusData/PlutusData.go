...
// CostModel is an ordered slice of integer cost parameters
// matching the on-chain CBOR encoding for a given Plutus
// language version.
type CostModel []int

// MarshalCBOR encodes the CostModel as a CBOR array of
// integers, preserving the existing slice order.
...
var COST_MODELSV2 = map[int]cbor.Marshaler{
	1: PLUTUSV2COSTMODEL,
}
